...
plugin = {
    ...
    "description": "Check file hash on [VirusTotal](https://www.virustotal.com/). With TLP `CLEAR`, in case the hash is not found, you would send the file to the service.",
    "disabled": False,
    "soft_time_limit": 800,
    "routing_key": "default",
...
params = [
    ...
    },
    {
        ...
        "name": "poll_distance",
        "type": "int",
        "description": "ThreatMatrix would sleep for this time between each poll to VT APIs",
        "is_secret": False,
        "required": False,
    },
    {
    ...
    },
    {
        ...
        "type": "int",
        "description": "ThreatMatrix would sleep for this time between each poll to VT APIs after having started a RE-scan",
        "is_secret": False,
        "required": False,
    },
    {
...
values = [
    {
        ...
        "value": 10,
        "updated_at": "2024-02-09T10:52:21.000434Z",
        "owner": None,
        "analyzer_config": "VirusTotal_v3_Get_File",
    ...
    },
    {
        ...
        "for_organization": False,
        "value": 30,
        "updated_at": "2024-02-09T10:52:21.049051Z",
        "owner": None,
        "analyzer_config": "VirusTotal_v3_Get_File",
        "connector_config": None,
        "visualizer_config": None,
    ...
    },
    {
        ...
        "for_organization": False,
        "value": 5,
        "updated_at": "2024-02-09T10:52:21.104789Z",
        "owner": None,
        "analyzer_config": "VirusTotal_v3_Get_File",
        "connector_config": None,
        "visualizer_config": None,
    ...
    },
    {
        ...
        "for_organization": False,
        "value": 120,
        "updated_at": "2024-02-09T10:52:21.132335Z",
        "owner": None,
        "analyzer_config": "VirusTotal_v3_Get_File",
        "connector_config": None,
        "visualizer_config": None,
    ...
    },
    {
        ...
        "for_organization": False,
        "value": False,
        "updated_at": "2024-02-09T10:52:21.171918Z",
        "owner": None,
        "analyzer_config": "VirusTotal_v3_Get_File",
        "connector_config": None,
        "visualizer_config": None,
    ...
    },
    {
        ...
        "for_organization": False,
        "value": 1,
        "updated_at": "2024-02-09T10:52:21.213322Z",
        "owner": None,
        "analyzer_config": "VirusTotal_v3_Get_File",
        "connector_config": None,
        "visualizer_config": None,
    ...
    },
    {
        ...
        "for_organization": False,
        "value": False,
        "updated_at": "2024-02-09T10:52:21.252412Z",
        "owner": None,
        "analyzer_config": "VirusTotal_v3_Get_File",
        "connector_config": None,
        "visualizer_config": None,
    ...
    },
    {
        ...
        "for_organization": False,
        "value": [],
        "updated_at": "2024-02-09T10:52:21.291369Z",
        "owner": None,
        "analyzer_config": "VirusTotal_v3_Get_File",
        "connector_config": None,
        "visualizer_config": None,
    ...
    },
    {
        ...
        "for_organization": False,
        "value": False,
        "updated_at": "2024-02-09T10:52:21.334925Z",
        "owner": None,
        "analyzer_config": "VirusTotal_v3_Get_File",
        "connector_config": None,
        "visualizer_config": None,
    ...
    },
    {
        ...
        "for_organization": False,
        "value": 30,
        "updated_at": "2024-02-09T10:52:21.352130Z",
        "owner": None,
        "analyzer_config": "VirusTotal_v3_Get_File",
        "connector_config": None,
        "visualizer_config": None,
    ...
    },
    {
        ...
        "for_organization": False,
        "value": "",
        "updated_at": "2024-02-09T10:52:21.019911Z",
        "owner": None,
        "analyzer_config": "VirusTotal_v3_Get_File",
        "connector_config": None,
        "visualizer_config": None,
