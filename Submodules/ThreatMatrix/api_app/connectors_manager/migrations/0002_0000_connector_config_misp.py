...
plugin = {
    ...
    "description": "Automatically creates an event on your MISP instance, linking the successful analysis on ThreatMatrix",
    "disabled": False,
    "soft_time_limit": 30,
    "routing_key": "default",
...
params = [
    ...
    },
    {
        ...
        "type": "bool",
        "description": "If ssl_check and this flag are True, the analyzer will leverage a CA_BUNDLE to authenticate against the MISP instance. ThreatMatrix will look for it at this path: `<project_location>/configuration/misp_ssl.crt`. Remember that this file should be readable by the application (`www-data` user must read this)",
        "is_secret": False,
        "required": False,
    },
    {
