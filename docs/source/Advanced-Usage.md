...
This page includes details about some advanced features that IntelX provides which can be **optionally** enabled. Namely,
...
##### from [Pyintelx](https://github.com/khulnasoft/pyintelx)
...
pyintelx_client.send_file_analysis_request(..., runtime_configuration=runtime_configuration)
```
#### PhoneInfoga
