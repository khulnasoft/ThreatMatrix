          ...
          <div className="w-full px-4 sm:w-2/3 lg:w-6/12">
            <div className="mb-10 w-full">
              <a href="/" className="mb-6 inline-block max-w-[160px]">
                <img
                  src="/images/threatmatrixwhite.png"
                  alt="logo"
              ...
              <a className="mb-6 inline-block max-w-[160px]" href="https://opencollective.com/khulnasoft/donate" target="_blank">
                <img
                    src="https://opencollective.com/khulnasoft/donate/button@2x.png?color=blue"
                    className="max-w-full"
                    alt="donate"
                    width={200}
                />
