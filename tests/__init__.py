    ...
    def setUpTestData(cls):
        try:
            ...
            cls.guest = User.objects.create(
                username="guest", email="guest@threatmatrix.khulnasoft.com", password="test"
            )
        ...
        try:
            ...
            cls.user = User.objects.create(
                username="user", email="user@threatmatrix.khulnasoft.com", password="test"
            )
        ...
        try:
            ...
            cls.admin = User.objects.create(
                username="admin", email="admin@threatmatrix.khulnasoft.com", password="test"
            )
        ...
        try:
            ...
            cls.superuser = User.objects.create_superuser(
                ...
                email="test@threatmatrix.khulnasoft.com",
                password="test",
            )
