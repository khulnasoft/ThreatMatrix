...
class JobViewSetTests(CustomViewSetTestCase):
    ...
    def test_agg_top_user_200(self):
        u = User.objects.create(
            username="test ;space@khulnasoft.com",
            email="test ;space@khulnasoft.com",
            is_superuser=False,
        )
        with patch(
            "django.utils.timezone.now",
        ...
        self.assertEqual(
            resp.json(),
            {
                "values": ["superuser@khulnasoft.com", "test ;space@khulnasoft.com"],
                "aggregation": [
                    {
                        "date": "2024-11-28T00:00:00Z",
                        "superuser@khulnasoft.com": 5,
                        "testspace@khulnasoft.com": 1,
                    },
                ],
            },
        )
