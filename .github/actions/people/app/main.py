...
query Q($after: String, $category_id: ID) {
  repository(name: "threatmatrix", owner: "khulnasoft") {
...
if __name__ == "__main__":
    ...
    if (
        ...
        logging.info("The ThreatMatrix People data hasn't changed, finishing.")
        sys.exit(0)
    ...
    branch_name = "threatmatrix-people"
    ...
    message = "👥 Update ThreatMatrix People"
