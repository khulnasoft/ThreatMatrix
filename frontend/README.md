...
- Start ThreatMatrix containers (see [docs](https://khulnasoft.github.io/ThreatMatrix-docs//ThreatMatrix/installation/)). Original dockerized app is accessible on `http://localhost:80`
