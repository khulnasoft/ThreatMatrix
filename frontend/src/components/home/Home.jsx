...
const blogPosts = [
  ...
  {
    title:
      "IntelX – OSINT tool automates the intel-gathering process using a single API",
  ...
  {
    title: "New year, new tool: IntelX",
    ...
    <>
      ...
      <Container id="home__content" className="mt-2">
        <ContentSection className="bg-body shadow lead">
          IntelX is an Open Source Intelligence, or OSINT solution to get
