...
plugin = {
    ...
    "description": "Emulate malware against [Dragonfly](https://dragonfly.certego.net/?utm_source=intelx) sandbox by [Certego S.R.L](https://certego.net).",
    "disabled": False,
    "soft_time_limit": 400,
    "routing_key": "long",
...
params = [
    ...
    },
    {
        ...
        "name": "profiles",
        "type": "list",
        "description": "List of profile indices for emulators. Refer to [profiles list](https://dragonfly.certego.net/dashboard/profiles?utm_source=intelx).",
        "is_secret": False,
        "required": False,
    },
    {
    ...
    },
    {
        ...
        "name": "api_key_name",
        "type": "str",
        "description": "Dragonfly API key. Generate [here](https://dragonfly.certego.net/me/sessions?utm_source=intelx).",
        "is_secret": True,
        "required": True,
    },
    {
