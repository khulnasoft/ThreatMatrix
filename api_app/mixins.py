...
class VirusTotalv3AnalyzerMixin(
    ...
    max_tries: int
    # ThreatMatrix would sleep for this time between each poll to VT APIs
    poll_distance: int
    # How many times we poll the VT API for RE-scan results (samples already available to VT)
    rescan_max_tries: int
    # ThreatMatrix would sleep for this time between each poll to VT APIs after having started a RE-scan
