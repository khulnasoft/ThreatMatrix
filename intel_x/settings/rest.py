...
REST_DURIN = {
    ...
    "API_ACCESS_CLIENT_NAME": "IntelXPy",
...
REST_EMAIL_AUTH = {
    ...
    "EMAIL_SUBJECT_VERIFICATION": "IntelX - Please Verify Your Email Address",
    "EMAIL_SUBJECT_DUPLICATE": "IntelX - Registration Attempt",
...
SPECTACULAR_SETTINGS = {
    "TITLE": "IntelX API specification",
    "VERSION": VERSION,
}
